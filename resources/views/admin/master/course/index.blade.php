                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        ...
                        <div class="heading-elements">
                            <a href="{{ route('admin.master.course.create') }}" class="btn btn-xs bg-teal-400 btn-labeled btn-ladda btn-ladda-spinner" data-style="slide-right">
...
@section('script')
    ...
    <script type="text/javascript">
        $(function(){
            ...
            /* DataTable */
            $('.datatable').DataTable({
                ajax: '{{ route('admin.master.course.datatable') }}',
                serverSide: true,
                columns: [
                    { data: 'DT_RowIndex' },
                    ...
                    { data: 'curriculum', className: 'text-center' },
