...
@section('content')
    @include('admin.layouts.partials.header', [
      ...
      'breadcrumbs' => ['User', ['Student', route('admin.user.student.index')], (@$data ? 'Edit' : 'Add New') . ' Student']
    ])
    <div class="content">
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="form-group has-feedback {{ $errors->has('email') ? 'has-error' : '' }}">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="email" placeholder="Student email .." value="{{ @$data ? $data->email : old('email') }}" required>
                    ...
                    <div class="form-group has-feedback {{ $errors->has('first_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="first_name" placeholder="Student first name .." value="{{ @$data ? $data->first_name : old('first_name') }}" required>
                            <div class="form-control-feedback">
                                <i class="icon-make-group text-muted"></i>
                            </div>
                    ...
                    <div class="form-group has-feedback {{ $errors->has('last_name') ? 'has-error' : '' }}">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="last_name" placeholder="Student last name .." value="{{ @$data ? $data->last_name : old('last_name') }}">
                            <div class="form-control-feedback">
                                <i class="icon-make-group text-muted"></i>
                            </div>
